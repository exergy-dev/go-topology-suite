...
// Test Within with various geometry types
...
// Test Disjoint with various geometry types
func TestDisjoint(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := Disjoint(tt.g1, tt.g2)
			if result != tt.expected {
				t.Errorf("Disjoint() = %v, want %v", result, tt.expected)
			}
		})
	}
}

// Test Overlaps with various geometry types
...
// Test Touches with various geometry types
func TestTouches(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := Touches(tt.g1, tt.g2)
			if result != tt.expected {
				t.Errorf("Touches() = %v, want %v", result, tt.expected)
			}
		})
	}
}
...
func TestPredicatesWithMultiGeometries(t *testing.T) {
	...
	t.Run("multipoint within polygon", func(t *testing.T) {
		if !Within(multiPoint, largePoly) {
